...
<h2>글쓰기</h2>
    ...
    <td><input type="text" size="30" maxlength="10" name="board_writer" value="홍길동"></td>
	</tr>
...
<!--     <tr>
    ...
    <td><textarea name="board_content" id="abc" rows="13" cols="50"></textarea> </td>
	</tr>
	
    <tr>
    <td width="100" align="center" >비밀번호</td>
    <td width="350"><input type="password" size="10" maxlength="12" name="board_passwd" value="1234"></td>
	</tr>
    <tr>
